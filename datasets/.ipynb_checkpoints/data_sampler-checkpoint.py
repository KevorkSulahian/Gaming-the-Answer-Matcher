...
def main():
    ...
    mmlu_pro_qual_sample_filtered = pd.read_csv("datasets/mmlu/mmlu_pro_qualitative_final_sample.csv")
    mmlu_pro_quant_sample_filtered = pd.read_csv("datasets/mmlu/mmlu_pro_quantitative_final_sample.csv")

    mmlu_pro_qual_answers = pd.read_csv("answer-matching/scores/mmlu/gpt_mmlu_pro_forward_qual_Qwen3-4B_judge.csv")
    ...
    answers_sample_qual.to_csv(
        "answer-matching/scores/mmlu/forward_qual/gpt_mmlu_pro_forward_qual_Qwen3-4B_judge.csv.csv",
        index=False
    )
