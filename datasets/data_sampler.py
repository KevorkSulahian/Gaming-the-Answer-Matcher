...
def main():
    ...
    sample_qual_questions = mmlu_pro_qual_sample["question"].tolist()
    sample_quant_questions = mmlu_pro_quant_sample["question"].tolist()
    ...
    answers_sample_qual.to_csv("answer-generation/mmlu/mmlu-verbose/gpt_mmlu_pro_verbose_qual_test_answers_sample_large.csv", index=False)
    answers_sample_quant.to_csv("answer-generation/mmlu/mmlu-verbose/gpt_mmlu_pro_verbose_quant_test_answers_sample_large.csv", index=False)
